...
function onContainerOpen(container, previousContainer)
  ...
  if previousContainer then
    ...
    if container:getName() == "locker" or container:getName() == "your inbox" or container:getName() == "Browse Field" then
      containerWindow = g_ui.createWidget('LockerContainerWindow', modules.game_interface.getRootPanel())
      lockerBool = true
    else
  ...
  local scrollbar
  if lockerBool then
    scrollbar = containerWindow:getChildById('miniwindowScrollBar')
    containerWindow.onEscape = function()
      g_game.close(container)
      containerWindow:hide()
    end
    containerWindow:getChildById('closeButton').onClick = function()
      g_game.close(container)
      containerWindow:hide()
    end
  else
